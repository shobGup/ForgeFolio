                ...
                <div className="row h-100 w-100 p-0 m-0">
                    ...
                    <div className="col h-100 form-container">
                        <div className="w-100 form m-0 p-0">
                            ...
                            <input className={"form-control mb-3 form-input" + (errors[1] ? " error-input" : "")} type="date" value={newWork.createdDate} onChange={(event) => {setNewWork((prev) => ({...prev, createdDate: event.target.value}))}}></input>
